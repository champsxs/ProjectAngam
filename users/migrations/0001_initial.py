# Generated by Django 4.0 on 2021-12-30 10:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shot_intro', models.CharField(blank=True, max_length=200, null=True)),
                ('bio', models.TextField(blank=True, null=True)),
                ('profile_image', models.ImageField(blank=True, default='pro_img/default_profile.svg', null=True, upload_to='pro_img/')),
                ('social_githib', models.CharField(blank=True, max_length=200, null=True)),
